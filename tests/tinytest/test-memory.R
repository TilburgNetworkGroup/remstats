...
inertia_decay <- rbind(
  matrix(0, ncol = nrow(riskset)),
  c(f(2, 1), 0, 0, 0, 0, 0, 0),
  c(f(3, 1), f(3, 2), 0, 0, 0, 0, 0),
  c(f(4, 1) + f(4, 3), f(4, 2), 0, 0, 0, 0, 0),
  c(f(5, 1) + f(5, 3), f(5, 2), f(5, 4), 0, 0, 0, 0),
  c(f(6, 1) + f(6, 3), f(6, 2), f(6, 4), 0, f(6, 5), 0, 0),
  c(f(7, 1) + f(7, 3), f(7, 2), f(7, 4), 0, f(7, 5), 0, f(7, 6)),
  c(f(8, 1) + f(8, 3), f(8, 2) + f(8, 7), f(8, 4), 0, f(8, 5), 0, f(8, 6)),
  c(f(9, 1) + f(9, 3), f(9, 2) + f(9, 7), f(9, 4) + f(9, 8), 0, f(9, 5), 0, f(9, 6)),
  c(f(10, 1) + f(10, 3), f(10, 2) + f(10, 7), f(10, 4) + f(10, 8), f(10, 9), f(10, 5), 0, f(10, 6))
)
...
outdegreeSender <- rbind(
  ...
  c(f(2, 1), 0, 0, 0),
  c(f(3, 1), f(3, 2), 0, 0),
  c(f(4, 1) + f(4, 3), f(4, 2), 0, 0),
  c(f(5, 1) + f(5, 3), f(5, 2) + f(5, 4), 0, 0),
  c(f(6, 1) + f(6, 3), f(6, 2) + f(6, 4), f(6, 5), 0),
  c(f(7, 1) + f(7, 3), f(7, 2) + f(7, 4), f(7, 5), f(7, 6)),
  c(f(8, 1) + f(8, 3), f(8, 2) + f(8, 4) + f(8, 7), f(8, 5), f(8, 6)),
  c(f(9, 1) + f(9, 3), f(9, 2) + f(9, 4) + f(9, 7) + f(9, 8), f(9, 5), f(9, 6)),
  c(f(10, 1) + f(10, 3), f(10, 2) + f(10, 4) + f(10, 7) + f(10, 8) + f(10, 9), f(10, 5), f(10, 6))
)
...
indegreeSender <- rbind(
  ...
  c(0, 0, f(2, 1), 0),
  c(f(3, 2), 0, f(3, 1), 0),
  c(f(4, 2), 0, f(4, 1) + f(4, 3), 0),
  c(f(5, 2), 0, f(5, 1) + f(5, 3) + f(5, 4), 0),
  c(f(6, 2), f(6, 5), f(6, 1) + f(6, 3) + f(6, 4), 0),
  c(f(7, 2), f(7, 5), f(7, 1) + f(7, 3) + f(7, 4) + f(7, 6), 0),
  c(f(8, 2) + f(8, 7), f(8, 5), f(8, 1) + f(8, 3) + f(8, 4) + f(8, 6), 0),
  c(f(9, 2) + f(9, 7), f(9, 5), f(9, 1) + f(9, 3) + f(9, 4) + f(9, 6) + f(9, 8), 0),
  c(f(10, 2) + f(10, 7), f(10, 5), f(10, 1) + f(10, 3) + f(10, 4) + f(10, 6) + f(10, 8), f(10, 9))
)
...
inertia <- rbind(
  ...
  c(0, 0, 0, 0),
  c(f(7, 2), 0, f(7, 4), 0),
  c(f(8, 2) + f(8, 7), 0, f(8, 4), 0),
  c(f(9, 2) + f(9, 7), 0, f(9, 4) + f(9, 8), 0),
  c(0, 0, f(10, 6), 0)
)

...
# send
send <- rbind(
  c(10, 10, 20, 20, 30, 30, 10, 10, 20, 20, 30, 30),
  c(10, 10, 20, 20, 30, 30, 10, 10, 20, 20, 30, 30),
  c(100, 100, 200, 200, 300, 300, 100, 100, 200, 200, 300, 300),
  c(100, 100, 200, 200, 300, 300, 100, 100, 200, 200, 300, 300),
  c(100, 100, 200, 200, 300, 300, 100, 100, 200, 200, 300, 300)
)
...
# receive
receive <- rbind(
  c(20, 30, 10, 30, 10, 20, 20, 30, 10, 30, 10, 20),
  c(20, 30, 10, 30, 10, 20, 20, 30, 10, 30, 10, 20),
  c(200, 300, 100, 300, 100, 200, 200, 300, 100, 300, 100, 200),
  c(200, 300, 100, 300, 100, 200, 200, 300, 100, 300, 100, 200),
  c(200, 300, 100, 300, 100, 200, 200, 300, 100, 300, 100, 200)
)
...
# average
average <- rbind(
  c(15, 20, 15, 25, 20, 25, 15, 20, 15, 25, 20, 25),
  c(15, 20, 15, 25, 20, 25, 15, 20, 15, 25, 20, 25),
  c(150, 200, 150, 250, 200, 250, 150, 200, 150, 250, 200, 250),
  c(150, 200, 150, 250, 200, 250, 150, 200, 150, 250, 200, 250),
  c(150, 200, 150, 250, 200, 250, 150, 200, 150, 250, 200, 250)
)
...
# difference
difference <- rbind(
  c(10, 20, 10, 10, 20, 10, 10, 20, 10, 10, 20, 10),
  c(10, 20, 10, 10, 20, 10, 10, 20, 10, 10, 20, 10),
  c(100, 200, 100, 100, 200, 100, 100, 200, 100, 100, 200, 100),
  c(100, 200, 100, 100, 200, 100, 100, 200, 100, 100, 200, 100),
  c(100, 200, 100, 100, 200, 100, 100, 200, 100, 100, 200, 100)
)
...
# maximum 
maximum <- rbind(
  c(20, 30, 20, 30, 30, 30, 20, 30, 20, 30, 30, 30),
  c(20, 30, 20, 30, 30, 30, 20, 30, 20, 30, 30, 30),
  c(200, 300, 200, 300, 300, 300, 200, 300, 200, 300, 300, 300),
  c(200, 300, 200, 300, 300, 300, 200, 300, 200, 300, 300, 300),
  c(200, 300, 200, 300, 300, 300, 200, 300, 200, 300, 300, 300)
)
...
# minimum
minimum <- rbind(
  c(10, 10, 10, 20, 10, 20, 10, 10, 10, 20, 10, 20),
  c(10, 10, 10, 20, 10, 20, 10, 10, 10, 20, 10, 20),
  c(100, 100, 100, 200, 100, 200, 100, 100, 100, 200, 100, 200),
  c(100, 100, 100, 200, 100, 200, 100, 100, 100, 200, 100, 200),
  c(100, 100, 100, 200, 100, 200, 100, 100, 100, 200, 100, 200)
)

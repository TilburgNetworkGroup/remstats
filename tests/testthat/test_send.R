...
test_that("expected statistic tie-oriented model", {
  ...
  stat1 <- first_info$extraversion[match(attr_object(tie_stats, "riskset")$sender, first_info$name)]
  ...
  stat2 <- second_info$extraversion[match(attr_object(tie_stats, "riskset")$sender, second_info$name)]
  ...
  stat3 <- third_info$extraversion[match(attr_object(tie_stats, "riskset")$sender, third_info$name)]

...
calculate_inertia_sampled <- function(edgelist, weights, risksetMatrix, riskset, memory, memory_value, start, stop, directed, consider_type, display_progress, method, sample_map) {
    .Call(`_remstats_calculate_inertia_sampled`, edgelist, weights, risksetMatrix, riskset, memory, memory_value, start, stop, directed, consider_type, display_progress, method, sample_map)
}

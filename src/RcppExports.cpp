...
arma::mat calculate_inertia_sampled(const arma::mat& edgelist, const arma::vec& weights, const arma::mat& risksetMatrix, const arma::mat& riskset, Rcpp::String memory, const arma::vec& memory_value, int start, int stop, bool directed, bool consider_type, bool display_progress, Rcpp::String method, const arma::imat& sample_map);
RcppExport SEXP _remstats_calculate_inertia_sampled(SEXP edgelistSEXP, SEXP weightsSEXP, SEXP risksetMatrixSEXP, SEXP risksetSEXP, SEXP memorySEXP, SEXP memory_valueSEXP, SEXP startSEXP, SEXP stopSEXP, SEXP directedSEXP, SEXP consider_typeSEXP, SEXP display_progressSEXP, SEXP methodSEXP, SEXP sample_mapSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type edgelist(edgelistSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::String >::type method(methodSEXP);
    Rcpp::traits::input_parameter< const arma::imat& >::type sample_map(sample_mapSEXP);
    rcpp_result_gen = Rcpp::wrap(calculate_inertia_sampled(edgelist, weights, risksetMatrix, riskset, memory, memory_value, start, stop, directed, consider_type, display_progress, method, sample_map));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_remstats_calculate_inertia_sampled", (DL_FUNC) &_remstats_calculate_inertia_sampled, 13},

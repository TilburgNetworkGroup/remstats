...
The recencySendSender effect refers to a recency statistic similar to
...
1/(the time that has past since sender i was last active as sender + 1).
Note that the 'recencySendSender' effect is only defined for directed
events.
